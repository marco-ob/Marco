<%@ Page Title="" Language="C#" MasterPageFile="~/INICIO_CLIENTE.Master" AutoEventWireup="true" CodeBehind="FrmCategoriaxProductoLogueado.aspx.cs" Inherits="CapaPresentacion.FrmCategoriaxProductoLogueado" %>
                    ...
                    <ItemTemplate>
                        <ul>
                            <li>
                                ...
                                <p><a href="FrmCategoriaxProductoLogueado.aspx?idcat=<%# Eval("Cate_ID") %>">
               ...
               <table>
                   ...
                   <tr>
                        <td>
                            ...
                            <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Mayor a 0" ControlToValidate="txtCantidad" MaximumValue="99" MinimumValue="1" Type="Integer"></asp:RangeValidator>
